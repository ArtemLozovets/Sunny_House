...
namespace Sunny_House.Areas.Administrator.Controllers
{
    ...
    public class UsersManagementController : Controller
    {
        ...
        #region ShowUsers Метод генерації списку користувачів-----------------------------------------------------
        ...
        #region Метод генерації таблиці аудиту входу користувачів --------------------------------------------
        [HttpGet]
        public ActionResult LoginAudit()
        {
            using (SunnyModel visitorcontext = new SunnyModel())
            {
                return View(visitorcontext.AspVisitors.ToList());
            }
        }

        #endregion

        #region BlockUser Метод блокування облікового запису користувача--------------------------------------
        ...
        #region UnblockUser Метод розблокування облікового запису користувача---------------------------------
        ...
        #region UpdateUserInfos Метод редагування даних користувача-------------------------------------------

        // GET: /UsersManagement/UpdateUserInfos
        [HttpGet]
        public ActionResult UpdateUserInfos(string UserId)
        {
        ...
        public async Task<ActionResult> UpdateUserInfos(UpdateUserInfosViewModel model)
        {
            if (!ModelState.IsValid)
            {
                ViewBag.ErMes = "Ошибка валидации модели";
        ...
        #region ChangePassword Метод зміни пароля користувача-------------------------------------------------
        ...
        #region SelfPasswordChange Метод зміни власного пароля користувачем-----------------------------------
        ...
        #region Метод виходу користувача із облікового запису(LogOff)-----------------------------------------
        ...
        #region Метод реєстрації нового користувача-----------------------------------------------------------
